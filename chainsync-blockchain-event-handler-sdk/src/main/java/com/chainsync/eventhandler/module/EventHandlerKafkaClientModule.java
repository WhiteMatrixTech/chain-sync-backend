...
import com.chainsync.eventhandler.util.YamlPropertySourceFactory;
...
import com.chainsync.eventhandler.client.FlowConvertedEventHistoryKafkaClient;
import com.chainsync.eventhandler.client.FlowConvertedEventKafkaClient;
...
@PropertySource(
    value = {
        "classpath:chainsync-blockchain-event-handler-config-${STAGE:local}.yml",
        "classpath:chainsync-common-kafka-${STAGE:local}.yml"
    },
