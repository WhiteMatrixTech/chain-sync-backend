...
@Log4j2
@Component
public class RinkebyBlockEventDao extends BaseQueryDao<EthereumBlockEvent> {

  public RinkebyBlockEventDao(
      @Qualifier(EventOrmManager.RINKEBY_EVENT_ORM_MANAGER)
