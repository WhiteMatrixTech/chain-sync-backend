package com.matrix.marketplace.blockchain.dao;

import static com.matrix.marketplace.blockchain.constants.Constants.CONNECTOR;
...
import com.matrix.marketplace.blockchain.model.BlockRange;
...
public class BlockchainTransactionDao extends BaseQueryDao<BlockchainTransaction> {
  ...
  private String getPartitionKey(final String chainType, final Long blockNumber) {
    return chainType + CONNECTOR + (blockNumber / BlockchainTransaction.BATCH_SIZE);
  }
