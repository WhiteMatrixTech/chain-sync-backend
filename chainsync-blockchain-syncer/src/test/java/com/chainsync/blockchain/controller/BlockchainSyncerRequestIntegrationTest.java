...
@SpringBootTest
class BlockchainSyncerRequestIntegrationTest {
  ...
  void test() {
    ...
    flowSyncRequest(blockingStub);
  }

  private void flowSyncRequest(BlockChainSyncServiceBlockingStub blockingStub) {
    SyncResponse response =
        blockingStub.rangeSyncRequest(
    ...
    assertEquals(SyncStatus.SUCCESS.name(), response.getStatus());
  }
}
