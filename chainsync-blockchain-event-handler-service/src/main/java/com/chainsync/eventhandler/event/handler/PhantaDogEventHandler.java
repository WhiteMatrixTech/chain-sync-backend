...
import com.chainsync.eventhandler.model.PhantaciNotify;
...
public class PhantaDogEventHandler implements BlockchainEventHandler {
  ...
  @Value("${phancyPet.address}")
  String phancyPetAddress;
  ...
  public boolean isApplicable(final BlockChainEvent blockChainEvent) {
    if (blockChainEvent instanceof EvmEvent
      ...
      return blockChainEvent.getContract().getNormalizedAddress().equals(phancyPetAddress);
    }
    return false;
  }
