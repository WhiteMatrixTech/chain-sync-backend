...
import static com.matrix.dynamodb.orm.AnnotatedDynamoDBTableOrmManagerTest.TestObject.GSI_HASH;
import static com.matrix.dynamodb.orm.AnnotatedDynamoDBTableOrmManagerTest.TestObject.GSI_RANGE;

import com.amazonaws.services.dynamodbv2.document.Item;
import com.google.common.collect.ImmutableMap;
import com.matrix.dynamodb.annotation.DynamoAttribute;
import com.matrix.dynamodb.annotation.DynamoHashKey;
import com.matrix.dynamodb.annotation.DynamoKey;
import com.matrix.dynamodb.annotation.DynamoRangeKey;
import com.matrix.dynamodb.annotation.DynamoTable;
import com.matrix.dynamodb.orm.dynamo.IndexDefinition;
