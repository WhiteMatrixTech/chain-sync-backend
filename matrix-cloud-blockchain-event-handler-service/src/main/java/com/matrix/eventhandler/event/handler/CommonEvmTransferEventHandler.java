...
import com.matrix.eventhandler.dao.TokenDao;
...
import com.matrix.eventhandler.module.ThreadPoolExecutorModule;
...
public class CommonEvmTransferEventHandler implements BlockchainEventHandler, InitializingBean {
  ...
  public void afterPropertiesSet() {
    web3j = Web3j.build(new HttpService(web3jEndPoint));
  }
}
